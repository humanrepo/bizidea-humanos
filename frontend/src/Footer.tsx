            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <h3 className="text-2xl font-bold text-blue-400 mb-4">Bizidea</h3>
                        <p className="text-gray-300 mb-4 max-w-md">
                            La plateforme tout-en-un pour transformer vos idées en business prospères. 
                            Créé avec passion par Arnold.Digital.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <a href="/pricing" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                                    Tarifs
                                </a>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <a href="/cookies" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                                    Politique des cookies
                                </a>
                            </li>
                            <li>
                                <a href="/gdpr" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                                    RGPD
                                </a>
                            </li>
                        </ul>
                ...
                <div className="border-t border-gray-800 mt-8 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="text-gray-400 text-sm mb-4 md:mb-0">
                            © {currentYear} Bizidea par Arnold.Digital. Tous droits réservés.
                        </div>
                        <div className="flex items-center space-x-4 text-sm text-gray-400">
                            <span>Fait avec ❤️ en RD Congo</span>
                            <span>•</span>
                            <a 
                                href="/status" 
