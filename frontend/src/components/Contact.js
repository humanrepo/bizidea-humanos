...
const Contact = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      // console.log('Données du formulaire:', data); // Suppression de la déclaration de console
      setIsSubmitted(true);
      reset();
    } catch (error) {
      // console.error('Erreur lors de l\'envoi:', error); // Suppression de la déclaration de console
    }
  };
